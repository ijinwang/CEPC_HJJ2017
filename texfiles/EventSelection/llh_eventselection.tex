\subsection{$\llh$ Event Selection}\label{subsec:selection}
...
% The recoil mass provide a very clear signature of the signal events, which have been delicately studied in \cite{CEPC:recoilmass}. 
%There are several cuts on the lepton pair system, including cuts on azimuth angle of lepton pair system, cuts on the lepton pair invariant mass 
%and lepton pair recoil mass.
...
%\footnote{The cuts on recoil mass was loosen in the fit and the signal and background events number in signal region was calculated }.
...
%The \ref{fig:kinematic_eeh} for $\mmh$ and $\eeh$ analysis.
